...
export class CoreService {
  ...
  // Utilisateur
  private _utilisateurs: BehaviorSubject<Utilisateur[] | null> =
    new BehaviorSubject(null);

  // Privilege
  private _privileges: BehaviorSubject<Privilege[] | null> =
    new BehaviorSubject(null);

  // parametrage
  private _parametrages: BehaviorSubject<Parametrages[] | null> =
    new BehaviorSubject(null);
    ...
    if (!type) {
      if (data.isGlobal) {
        ...
        return this._httpClient
          .get((customBaseUrl ? customBaseUrl : environment.apiUrl) + url, {
            params: options,
          })
          .pipe(
            map((response) => {
        ...
        return this._httpClient
          .get(
            (customBaseUrl ? customBaseUrl : environment.apiUrl) +
              url +
              "?isGlobal=" +
              data.isGlobal +
              "&searchQuery=" +
        ...
        return this._httpClient
          ...
          .pipe(
            map((response) => {
              ...
              return {
                list: response[this.constantes.RESPONSE_DATA],
  ...
  searchClientByNature(code, url) {
    return this._httpClient
      .get(
        environment.apiUrl + url + "/" + code.nature + "/" + code.numeroPiece
      )
      .pipe((response) => response);
  }
  ...
  searchClientByNatureMorale(code, url) {
    return this._httpClient
      .get(environment.apiUrl + url + "/" + code.ninea)
      .pipe((response) => response);
  }
  ...
  listFormulaire(url, params?) {
    ...
    return this._httpClient
      .get(environment.apiUrl + url, { params: options })
      .pipe((response) => response);
  }
  addFileExtourne(data) {
    return this._httpClient
      .post(environment.apiUrl + "extourner-transactions-par-fichier", data)
      .pipe(
  ...
  rapportBic(dateFormatee, url) {
    return this._httpClient
      .get(environment.apiUrl + url + dateFormatee, { responseType: "blob" })
      .pipe((response) => response);
  }
  ...
  addItem(item, url): Observable<any> {
    return this._httpClient
      .post(environment.apiUrl + url, item)
  ...
  getPapByCodePap(type: string, codePap: string): Observable<any> {
    ...
    return this._httpClient.get<any>(
      `${environment.apiUrl}${endpoint}/byCodePap/${codePap}`
    );
  }
  ...
  deleteItem(item, url) {
    return this._httpClient
      .delete(environment.apiUrl + url + "/" + item, item)
      .pipe((response) => response);
  }
  ...
  leverCompteInactif(url, compte) {
    return this._httpClient
      .post(environment.apiUrl + url, compte)
      .pipe(switchMap((response: any) => of(response)));
  }
  ...
  leverCompteDormant(compte) {
    return this._httpClient
      .get(environment.apiUrl + "lever-compte-dormant" + "/" + compte.id)
      .pipe((response) => response);
  }

  liberer(id) {
    return this._httpClient
      .get(environment.apiUrl + "liberer-fonds" + "/" + id)
      .pipe((response) => response);
  }

  signataire(id) {
    return this._httpClient
      .delete(environment.apiUrl + "signataire-client" + "/" + id)
      .pipe((response) => response);
  }

  getElementByIdTransaction(
    item,
    url,
    offset,
    max,
  ...
  extournerTransaction(data) {
    return this._httpClient
      .post(environment.apiUrl + "extourner-transaction", data)
      .pipe((response) => response);
  }

  annulerTransaction(data) {
    return this._httpClient
      .post(environment.apiUrl + "annuler-transaction", data)
      .pipe((response) => response);
  }
  rejeterDemand(data, url, id) {
    return this._httpClient
      .post(environment.apiUrl + url + id, data)
      .pipe((response) => response);
  }
  ...
  validerDemandeCred(data, id, url) {
    return this._httpClient
      .get(environment.apiUrl + url + "/" + id, data)
      .pipe((response) => response);
  }
  ...
  bloquerDepot(id, data) {
    return this._httpClient
      .post(environment.apiUrl + "depot-terme/debloquer/" + id, data)
      .pipe((response) => response);
  }
  rejetDemande(id, data) {
    return this._httpClient
      .post(environment.apiUrl + "demandes-credits/rejeter/" + id, data)
      .pipe((response) => response);
  }
  fermerExercice() {
    return this._httpClient
      .get(environment.apiUrl + "fermer-exercice", {})
      .pipe((response) => response);
  }
  detailExercice(data) {
    return this._httpClient
      .get(environment.apiUrl + "detail-exercice/" + data, {})
      .pipe((response) => response);
  }
  rejetVirementPerm(id, data) {
    return this._httpClient
      .post(environment.apiUrl + "virements-permanents/rejeter/" + id, data)
      .pipe((response) => response);
  }
  validerAvance(id, data) {
    return this._httpClient
      .post(environment.apiUrl + "depot-terme/avance/" + id, data)
      .pipe((response) => response);
  }

  bloquerCompte(id) {
    return this._httpClient
      .get(environment.apiUrl + "compte-bloquer" + "/" + id)
      .pipe((response) => response);
  }
  ...
  valider(data) {
    return this._httpClient
      .post(environment.apiUrl + "remboursement-anticiper", data)
      .pipe((response) => response);
  }

  lock(compte) {
    return this._httpClient
      .put(environment.apiUrl + "compte-bloquer/" + compte?.id, compte)
      .pipe(
        switchMap((response: any) =>
          // Return a new observable with the response
          of(response)
  ...
  locked(url, compte) {
    return this._httpClient
      .put(environment.apiUrl + url + "/" + compte?.id, compte)
      .pipe(
        switchMap((response: any) =>
          // Return a new observable with the response
          of(response)
  ...
  financer(item, id, url): Observable<any[]> {
    return this._httpClient
      .post(environment.apiUrl + url + "/" + id, item)
      .pipe(switchMap((response: any) => of(response)));
  }
