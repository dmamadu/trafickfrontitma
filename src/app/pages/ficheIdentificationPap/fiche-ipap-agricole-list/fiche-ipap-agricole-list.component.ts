...
import { PapFormComponent } from "../app-form/app-form.component";

@Component({
  selector: 'app-fiche-ipap-agricole-list',
  standalone: true,
  templateUrl: './fiche-ipap-agricole-list.component.html',
  styleUrl: './fiche-ipap-agricole-list.component.css',
  providers: [
      DatePipe,
      {
...
export class FicheIPapAgricoleListComponent implements OnInit {
...
addItems(): void {
  this._matDialog.open(PapFormComponent, {
    width: "auto",
    height: "auto",
    maxHeight: "90vh", // Limite à 90% de la hauteur de l'écran
    data: {
      action: "new",
      pap: '',
