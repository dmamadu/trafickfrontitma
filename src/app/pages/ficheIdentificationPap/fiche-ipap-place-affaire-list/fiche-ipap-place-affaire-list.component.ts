...
import { AddPapPlaceAffaireComponent } from "../../pap/pap-place-affaire/add-pap-place-affaire/add-pap-place-affaire.component";
import { Pap } from "../../pap/pap.model";

@Component({
  selector: 'app-fiche-ipap-place-affaire-list',
  standalone: true,
  templateUrl: './fiche-ipap-place-affaire-list.component.html',
  styleUrl: './fiche-ipap-place-affaire-list.component.css',
  providers: [
    DatePipe,
    {
...
export class FicheIPapPlaceAffaireListComponent implements OnInit {
