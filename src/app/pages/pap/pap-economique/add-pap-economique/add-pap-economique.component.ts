...
@Component({
  selector: 'app-add-pap-economique',
  standalone: true,
  templateUrl: './add-pap-economique.component.html',
  styleUrl: './add-pap-economique.component.css',
  imports: [
    MatFormFieldModule,
    MatInputModule,
    MatIconModule,
...
export class AddPapEconomiqueComponent {
  ...
  constructor(
    public matDialogRef: MatDialogRef<AddPapEconomiqueComponent>,
  ...
  initForms(donnees?) {
    this.initForm = this.fb.group({
      ...
      photoEquipement: this.fb.control(
        donnees ? donnees.photoEquipement : null
      ),
      photoFicheConsentement: this.fb.control(
        donnees ? donnees.photoFicheConsentement : null
      ),

      descriptionCloture: this.fb.control(
        donnees ? donnees.descriptionCloture : null
      ),
      descriptionEquipement: this.fb.control(
        donnees ? donnees.descriptionEquipement : null
      ),
      descriptionAnimeaux: this.fb.control(
        donnees ? donnees.descriptionAnimeaux : null
      ),

      descriptionBatiment: this.fb.control(
        donnees ? donnees.descriptionBatiment : null
      ),

      detailCoproprietaire: this.fb.control(
        donnees ? donnees.detailCoproprietaire : null
      ),

      detailEmploye: this.fb.control(
        donnees ? donnees.detailEmploye : null
      ),

      contactRepresentant: this.fb.control(
        donnees ? donnees.contactRepresentant : null
      ),

      nomCompletRepresentant: this.fb.control(
        donnees ? donnees.nomCompletRepresentant : null
      ),

      nomEntreprise: this.fb.control(
        donnees ? donnees.nomEntreprise : null
      ),

      statutStructure: this.fb.control(
        donnees ? donnees.statutStructure : null
      ),

      statutJuridiqueStructure: this.fb.control(
        donnees ? donnees.statutJuridiqueStructure : null
      ),

      personneInterroge: this.fb.control(
        donnees ? donnees.personneInterroge : null
      ),

      photoPlaceAffaire: this.fb.control(
        donnees ? donnees.photoPlaceAffaire : null
      ),

      adresseMail: this.fb.control(
        donnees ? donnees.adresseMail : null
      ),

      nombreCoproprietatire: this.fb.control(
        donnees ? donnees.nombreCoproprietatire : null
      ),
