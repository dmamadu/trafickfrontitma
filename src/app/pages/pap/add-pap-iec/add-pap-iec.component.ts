...
// Messages constants
const MESSAGES = {
  ADD_CONFIRM: "Voulez-vous vraiment ajouter ce pap IEC ?",
  UPDATE_CONFIRM: "Voulez-vous vraiment modifier cette personne affectée ?",
  ADD_SUCCESS: "Pap IEC ajouté avec succés",
...
@Component({
  ...
  templateUrl: './add-pap-iec.component.html',
  styleUrl: './add-pap-iec.component.css'
})
export class AddPapIecComponent implements OnInit, OnDestroy {
  ...
  constructor(
    public matDialogRef: MatDialogRef<AddPapIecComponent>,
    ...
    this.dialogTitle = this.labelButton + " un pap IEC";
